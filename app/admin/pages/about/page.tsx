...
/**
 * The About page is edited in the canvas now, as a list of sections.
 *
 ...
 * on two different rules. The menu label and whether the page exists at all
 ...
 */
export default function AboutFormMoved() {
  redirect('/edit/about')
}
