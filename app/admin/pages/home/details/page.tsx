  ...
  return (
    <div>
      <p className="admin-crumb">
        <Link href="/admin/pages/home">← Homepage sections</Link>
      </p>

      <div className="page-editor-head">
        <div>
          <h1 className="admin-h1">Stories &amp; type</h1>
          <p className="admin-meta" style={{ margin: '0.35rem 0 0', maxWidth: '46ch', lineHeight: 1.6 }}>
            The featured stories, where each photograph is cropped, and the typography. Order,
            headings and which sections appear are on the{' '}
            <Link href="/admin/pages/home" style={{ borderBottom: '0.5px solid currentColor' }}>
              sections list
            </Link>
            — both sides stay in step, so it does not matter which one you use.
          </p>
        </div>
